package com.xq.mydrawerlayoutnavigationview.fab;
...
import com.xq.mydrawerlayoutnavigationview.fab.adapter.GridAdapter;
import com.xq.mydrawerlayoutnavigationview.fab.model.Meizi;
import com.xq.mydrawerlayoutnavigationview.fab.util.MyOkhttp;
import com.xq.mydrawerlayoutnavigationview.fab.util.StatusBarUtil;
...
public class FabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBarUtil.setStatusBarColor(FabActivity.this, R.color.colorPrimaryDark);//设置状态栏颜色
    ...
    private class GetData extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (!TextUtils.isEmpty(result)) {
                ...
                if (mAdapter == null) {
                    recyclerview.setAdapter(mAdapter = new GridAdapter(FabActivity.this, meizis));
